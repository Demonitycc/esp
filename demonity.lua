...
if not isfile("demonity.cc") then
  makefolder("demonity.cc")
end

local menu = game:GetObjects("rbxassetid://83190324880994")[1] 
...
for _, obj in pairs(menu:GetDescendants()) do
  if obj.Name:lower():find('userlabel') then
      obj.Text = 'active user: <font color="rgb(45, 116, 202)">' .. game.Players.LocalPlayer.Name .. '</font>'
  end
  if obj.Name:lower():find('buildlabel') then
      obj.Text = 'build: <font color="rgb(45, 116, 202)">Public</font>'
  end
end
...
KeybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(45, 116, 202)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
...
Name.Text = "[<font color=\"rgb(45, 116, 202)\">Keybinds</font>]"
...
Name_2.Text = "Silent Aim: <font color=\"rgb(45, 116, 202)\">[MB1]</font>"
...
local function createWatermark()
  ...
  WatermarkFrame.BorderColor3 = Color3.fromRGB(45, 116, 202)
  ...
  task.spawn(function()
     while task.wait() do
       ...
       WaterMarkLabel.Text = 'demonity.cc<font color="rgb(74, 74, 74)"></font> - uid: <font color="rgb(74, 74, 74)">' .. uid .. '</font> / fps: <font color="rgb(45, 116, 202)">' .. fpsValue .. '</font> / ping: <font color="rgb(45, 116, 202)">' .. ping .. '</font> / time: <font color="rgb(45, 116, 202)">' .. time .. '</font>'
     end
  end)
  return Watermark
end
...
local library = {
  Title = 'demonity.cc<font color="rgb(74, 74, 74)"></font> | Private',
  keybind = Enum.KeyCode.RightBracket,
  Watermark = createWatermark(),
     Colors = {
        libColor = Color3.fromRGB(45, 116, 202),
        riskyColor = Color3.fromRGB(255, 0, 0),
        FontColor = Color3.fromRGB(255, 255, 255),
        MainColor = Color3.fromRGB(14, 14, 14),
        AccentColor = Color3.fromRGB(45, 116, 202),
  ...
  CloneScreenGui.Name = "demonity.cc_gui"

  for _, obj in pairs(menu:GetDescendants()) do
      if obj.Name:lower():find('name_esp') then
         obj.Text = '<font color="rgb(45, 116, 202)">' .. game.Players.LocalPlayer.Name .. '</font>'
      end
  end
  ...
  library:Create('UIListLayout', {Padding = UDim.new(0, 4); FillDirection = Enum.FillDirection.Vertical; SortOrder = Enum.SortOrder.LayoutOrder; Parent = library.NotificationArea})
      ...
      function library:Notify(Text, Time)
          ...
          local NotifyOuter = library:Create('Frame', {BorderColor3 = Color3.new(45, 116, 202); Position = UDim2.new(0, 100, 0, 10); Size = UDim2.new(0, 0, 0, YSize); ClipsDescendants = true; Transparency = 0; ZIndex = 100; Parent = library.NotificationArea})
          ...
          draggable(menu.BG)
              ...
              function library:Tween(...) TweenService:Create(...):Play() end
                  function library:addTab(name,image)
                      ...
                      local imageTweenStart = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(45, 116, 202)})
                      local textTweenStart = TweenService:Create(v.text, tweenInfo, {TextColor3 = Color3.fromRGB(45, 116, 202)})
                      ...
                      function group:addToggle(args)
                          ...
                          function toggle:addKeybind(args)
                                  ...
                                  if key.Name == "Unknown" or key.Name == "Unknown" then
                                      ...
                                      if args.gui then
                                          ...
                                          if args.type == "hold" then
                                              Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(45, 116, 202)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                          else
                                              if not Toggle then
                                                  Toggle = true
                                                  Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(45, 116, 202)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                  ...
                                                  Toggle = false
                                                  Name.Text = "<font color=\"rgb(125, 125, 125)\">" ..args.text.. ": /font>".." <font color=\"rgb(45, 116, 202)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                              end
                                          end
                                      end
                                  end
                              ...
                              if args.gui then
                                  Name.Visible = true
                                  Name.Text = args.text..": <font color=\"rgb(45, 116, 202)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                              end
                      ...
                      function contains(list, x)
                          for _, v in pairs(list) do
                              ...
                              writefile("demonity.cc/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                      ...
                      local tbl = {}
                      for i,v in next, listfiles("demonity.cc") do table.insert(tbl,v) end
